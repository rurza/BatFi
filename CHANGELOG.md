...
- **Calendar / Automation.** A new **Automation** settings pane lets you automate your
  ...
  right now wins.
- When automation is enabled, the menu-bar dropdown shows an explanatory status row (the
  active rule, the limit it's enforcing, and until when — or the next upcoming rule when
  idle). Clicking it jumps straight to the Automation pane.
...
[3.0.6]: https://github.com/rurza/BatFi-Priv/compare/3.0.4...3.0.6
